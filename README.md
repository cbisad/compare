Script comparing OpenStack packages version as well as docker container version between OpenStack nodes running in Red Hat OpenStack.

Arrays are used to start node IP and role type to be used within loops.
